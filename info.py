...
API_ID = int(environ.get('API_ID', '26994286'))
API_HASH = environ.get('API_HASH', 'e52fd847274e59a752c132bdfed455d2')
BOT_TOKEN = environ.get('BOT_TOKEN', "8420615031:AAGuOinUANEyTJUqecgH6FanrZAMdyoQsCU")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1757987972 5655566777').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002611629890'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002611629890').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002595245935')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://walterwhite:BOCi0lUdHTMCwEXY@cluster0.lbgye7y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "walterwhite")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'waltercollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+thrZhHZrRmo0YWVl')
CHNL_LNK = environ.get('CHNL_LNK', '')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+OWYvcHDY66tkYTZl') # Support Chat Link Without https:// or @
